  ...
  <div class="ratings" v-el:ratings>
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <g-star :size="36" :score="seller.serviceScore"></g-star>
            <span class="score">{{seller.serviceScore}}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <g-star :size="36" :score="seller.foodScore"></g-star>
      ...
      <div class="rating-wrapper">
        <ul>
          <li v-show="rateVisible(rating.rateType, rating.text)" v-for="rating in ratings" class="rating-item">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <g-star :size=24 :score="rating.score"></g-star>
